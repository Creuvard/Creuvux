...
extern char	  *crv_getenv(const char *);
extern int	  crv_client_create(int , const char *, int );
extern int	  crv_remove_files_in_directory (char *);
extern char	  *crv_sha1(const char *);
extern int	  crv_strncmp(const char *, const char *);
extern char		*crv_strcasestr(const char *, const char *);
extern int		crv_move(const char *, const char *);
